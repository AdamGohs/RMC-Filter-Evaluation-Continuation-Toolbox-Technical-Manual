...
Step 1 characterizes the base soil. FEMA [@cite-FEMA2011] indicates the coarsest *D<sub>15</sub>B* before regrading is used to evaluate permeability requirements. Step 1 obtains the coarsest *D<sub>15</sub>B* before regrading from the Base Gradation worksheet, where it is interpolated using a logarithmic scale for particle size and linear scale for percent passing. Figure \@ref(fig:figure-38) is an example of step 1.
