...
```{r figure-17, echo=FALSE, fig.align="center", fig.cap="Example regrading calculation on No. 4 sieve (United States Bureau of Reclamation [USBR] 2011).", out.width="100%"}
...
```{r figure-18, echo=FALSE, fig.align="center", fig.cap="Step 3 of Base Gradation worksheet: Regraded base soil gradation.", out.width="100%"}
