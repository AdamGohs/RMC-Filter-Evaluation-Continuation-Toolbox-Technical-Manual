...
```{r figure-1, echo=FALSE, fig.align="center", fig.cap='Security warning message bars with the "Enable Content" option to enable macros.'}
...
```{r figure-2, echo=FALSE, fig.cap="Calculation worksheet heading.", fig.align="center"}
...
```{r figure-3, echo=FALSE, fig.cap="Headwater and tailwater input: NAVD88.", fig.align="center"}
knitr::include_graphics("images/figure3.png")
```

```{r figure-4, echo=FALSE, fig.cap="Headwater and tailwater input: NGVD29.", fig.align="center"}
knitr::include_graphics("images/figure4.png")
```

```{r figure-5, echo=FALSE, fig.cap="Headwater and tailwater input: User-specified datum.", fig.align="center"}
...
```{r figure-6, echo=FALSE, fig.cap="Example of step banner.", fig.align="center"}
knitr::include_graphics("images/figure6.png")
```

```{r figure-7, echo=FALSE, fig.cap="Example of option banner.", fig.align="center"}
