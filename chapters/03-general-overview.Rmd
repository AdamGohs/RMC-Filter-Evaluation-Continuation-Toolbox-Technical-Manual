...
```{r figure-1, fig.cap='Security warning message bars with the "Enable Content" option to enable macros.', fig.align="center"}
...
```{r figure-2, fig.cap="Calculation worksheet heading.", fig.align="center"}
...
```{r figure-3, fig.cap="Headwater and tailwater input: NAVD88.", fig.align="center"}
knitr::include_graphics("images/figure3.png")
```

```{r figure-4, fig.cap="Headwater and tailwater input: NGVD29.", fig.align="center"}
knitr::include_graphics("images/figure4.png")
```

```{r figure-5, fig.cap="Headwater and tailwater input: User-specified datum.", fig.align="center"}
...
```{r figure-6, fig.cap="Example of step banner.", fig.align="center"}
knitr::include_graphics("images/figure6.png")
```

```{r figure-7, fig.cap="Example of option banner.", fig.align="center"}
